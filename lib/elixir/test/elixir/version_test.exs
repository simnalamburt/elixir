...
defmodule VersionTest do
  ...
  test "^" do
    refute V.match?("0.0.0", "^ 1")
    refute V.match?("0.0.1", "^ 1")
    refute V.match?("0.0.2", "^ 1")
    refute V.match?("0.1.0", "^ 1")
    refute V.match?("0.1.1", "^ 1")
    refute V.match?("0.1.2", "^ 1")
    refute V.match?("0.2.0", "^ 1")
    refute V.match?("0.2.1", "^ 1")
    refute V.match?("0.2.2", "^ 1")
    assert V.match?("1.0.0", "^ 1")
    assert V.match?("1.0.1", "^ 1")
    assert V.match?("1.0.2", "^ 1")
    assert V.match?("1.1.0", "^ 1")
    assert V.match?("1.1.1", "^ 1")
    assert V.match?("1.1.2", "^ 1")
    assert V.match?("1.2.0", "^ 1")
    assert V.match?("1.2.1", "^ 1")
    assert V.match?("1.2.2", "^ 1")
    refute V.match?("2.0.0", "^ 1")
    refute V.match?("0.1.0-alpha", "^ 1")
    refute V.match?("1.0.0-beta1", "^ 1")
    refute V.match?("1.0.1-pre", "^ 1")

    refute V.match?("0.0.0", "^ 1.1")
    refute V.match?("0.0.1", "^ 1.1")
    refute V.match?("0.0.2", "^ 1.1")
    refute V.match?("0.1.0", "^ 1.1")
    refute V.match?("0.1.1", "^ 1.1")
    refute V.match?("0.1.2", "^ 1.1")
    refute V.match?("0.2.0", "^ 1.1")
    refute V.match?("0.2.1", "^ 1.1")
    refute V.match?("0.2.2", "^ 1.1")
    refute V.match?("1.0.0", "^ 1.1")
    refute V.match?("1.0.1", "^ 1.1")
    refute V.match?("1.0.2", "^ 1.1")
    assert V.match?("1.1.0", "^ 1.1")
    assert V.match?("1.1.1", "^ 1.1")
    assert V.match?("1.1.2", "^ 1.1")
    assert V.match?("1.2.0", "^ 1.1")
    assert V.match?("1.2.1", "^ 1.1")
    assert V.match?("1.2.2", "^ 1.1")
    refute V.match?("2.0.0", "^ 1.1")
    refute V.match?("0.1.0-alpha", "^ 1.1")
    refute V.match?("1.0.0-beta1", "^ 1.1")
    refute V.match?("1.0.1-pre", "^ 1.1")

    refute V.match?("0.0.0", "^ 1.1.1")
    refute V.match?("0.0.1", "^ 1.1.1")
    refute V.match?("0.0.2", "^ 1.1.1")
    refute V.match?("0.1.0", "^ 1.1.1")
    refute V.match?("0.1.1", "^ 1.1.1")
    refute V.match?("0.1.2", "^ 1.1.1")
    refute V.match?("0.2.0", "^ 1.1.1")
    refute V.match?("0.2.1", "^ 1.1.1")
    refute V.match?("0.2.2", "^ 1.1.1")
    refute V.match?("1.0.0", "^ 1.1.1")
    refute V.match?("1.0.1", "^ 1.1.1")
    refute V.match?("1.0.2", "^ 1.1.1")
    refute V.match?("1.1.0", "^ 1.1.1")
    assert V.match?("1.1.1", "^ 1.1.1")
    assert V.match?("1.1.2", "^ 1.1.1")
    assert V.match?("1.2.0", "^ 1.1.1")
    assert V.match?("1.2.1", "^ 1.1.1")
    assert V.match?("1.2.2", "^ 1.1.1")
    refute V.match?("2.0.0", "^ 1.1.1")
    refute V.match?("1.1.1-alpha1", "^ 1.1.1")
    refute V.match?("1.1.2-beta1", "^ 1.1.1")
    refute V.match?("2.0.0-pre", "^ 1.1.1")

    refute V.match?("0.0.0", "^ 0.1")
    refute V.match?("0.0.1", "^ 0.1")
    refute V.match?("0.0.2", "^ 0.1")
    assert V.match?("0.1.0", "^ 0.1")
    assert V.match?("0.1.1", "^ 0.1")
    assert V.match?("0.1.2", "^ 0.1")
    refute V.match?("0.2.0", "^ 0.1")

    refute V.match?("0.0.0", "^ 0.1.1")
    refute V.match?("0.0.1", "^ 0.1.1")
    refute V.match?("0.0.2", "^ 0.1.1")
    refute V.match?("0.1.0", "^ 0.1.1")
    assert V.match?("0.1.1", "^ 0.1.1")
    assert V.match?("0.1.2", "^ 0.1.1")
    refute V.match?("0.2.0", "^ 0.1.1")
    refute V.match?("0.1.1-alpha1", "^ 0.1.1")
    refute V.match?("0.1.2-beta1", "^ 0.1.1")
    refute V.match?("0.2.0-pre", "^ 0.1.1")

    refute V.match?("0.0.0", "^ 0.0.1")
    assert V.match?("0.0.1", "^ 0.0.1")
    refute V.match?("0.0.2", "^ 0.0.1")
    refute V.match?("0.1.0", "^ 0.0.1")
    refute V.match?("1.0.0", "^ 0.0.1")

    assert V.match?("0.0.0", "^ 0.0")
    assert V.match?("0.0.2", "^ 0.0")
    refute V.match?("0.1.0", "^ 0.0")
    refute V.match?("0.2.1", "^ 0.0")
    refute V.match?("1.3.4", "^ 0.0")

    assert V.match?("0.0.0", "^ 0")
    assert V.match?("0.0.2", "^ 0")
    assert V.match?("0.1.0", "^ 0")
    assert V.match?("0.2.1", "^ 0")
    refute V.match?("1.3.4", "^ 0")
    refute V.match?("2.0.0", "^ 0")

    refute V.match?("0.9.9", "^ 1.2.3-beta.4")
    refute V.match?("1.2.2", "^ 1.2.3-beta.4")
    refute V.match?("1.2.3-alpha", "^ 1.2.3-beta.4")
    refute V.match?("1.2.3-beta.3", "^ 1.2.3-beta.4")
    assert V.match?("1.2.3-beta.4", "^ 1.2.3-beta.4")
    assert V.match?("1.2.3-beta.5", "^ 1.2.3-beta.4")
    assert V.match?("1.2.3-c", "^ 1.2.3-beta.4")
    assert V.match?("1.2.3", "^ 1.2.3-beta.4")
    assert V.match?("1.2.4", "^ 1.2.3-beta.4")
    assert V.match?("2.0.0", "^ 1.2.3-beta.4")

    refute V.match?("0.2.0-pre", "^ 0.2.3-alpha3")
    refute V.match?("0.2.3-pre", "^ 0.2.3-alpha3")
    refute V.match?("0.2.3-alpha1", "^ 0.2.3-alpha3")
    refute V.match?("0.2.3-alpha2", "^ 0.2.3-alpha3")
    assert V.match?("0.2.3-alpha3", "^ 0.2.3-alpha3")
    assert V.match?("0.2.3-alpha4", "^ 0.2.3-alpha3")
    assert V.match?("0.2.3-beta", "^ 0.2.3-alpha3")
    assert V.match?("0.2.3", "^ 0.2.3-alpha3")
    assert V.match?("0.2.5", "^ 0.2.3-alpha3")
    refute V.match?("0.3.0", "^ 0.2.3-alpha3")
  end
