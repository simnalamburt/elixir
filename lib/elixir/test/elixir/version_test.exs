...
defmodule VersionTest do
  ...
  test "^" do
    ...
    refute Version.match?("0.1.0-alpha", "^ 1")
    refute Version.match?("1.0.0-beta1", "^ 1")
    refute Version.match?("1.0.1-pre", "^ 1")
    ...
    refute Version.match?("0.1.0-alpha", "^ 1.1")
    refute Version.match?("1.0.0-beta1", "^ 1.1")
    refute Version.match?("1.0.1-pre", "^ 1.1")
    ...
    refute Version.match?("1.1.1-alpha1", "^ 1.1.1")
    refute Version.match?("1.1.2-beta1", "^ 1.1.1")
    refute Version.match?("2.0.0-pre", "^ 1.1.1")
    ...
    refute Version.match?("0.1.1-alpha1", "^ 0.1.1")
    refute Version.match?("0.1.2-beta1", "^ 0.1.1")
    refute Version.match?("0.2.0-pre", "^ 0.1.1")
    ...
    assert Version.match?("1.2.3-c", "^ 1.2.3-beta.4")
    assert Version.match?("1.2.3", "^ 1.2.3-beta.4")
    assert Version.match?("1.2.4", "^ 1.2.3-beta.4")
    assert Version.match?("2.0.0", "^ 1.2.3-beta.4")

    refute Version.match?("0.2.0-pre", "^ 0.2.3-alpha3")
    refute Version.match?("0.2.3-pre", "^ 0.2.3-alpha3")
